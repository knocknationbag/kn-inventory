...
const TABLES = [
  { table: "settings", columns: "shop_name,phones,email,address,gst_number,pan,bank_name,bank_account,bank_ifsc,bank_branch,invoice_prefix,next_invoice_no,default_gst_rate,low_stock_threshold" },
