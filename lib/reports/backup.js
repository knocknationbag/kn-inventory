...
const TABLES = [
  { table: "settings", columns: "shop_name,phones,address,gst_number,pan,bank_name,bank_account,bank_ifsc,bank_branch,invoice_prefix,next_invoice_no,default_gst_rate,low_stock_threshold" },
  ...
  { table: "products", columns: "id,sku,name,colour,size,category_id,supplier_id,opening_stock,purchase_rate,selling_rate,gst_rate,hsn_code,is_active,created_at" },
