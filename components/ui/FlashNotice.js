...
const NOTICES = {
  ...
  gst_saved: "GST invoice saved. Stock updated.",
  gst_deleted: "GST invoice deleted. Stock updated.",
  gst_draft_saved: "Draft saved. Stock is not changed until you finalize it.",
